...
function PostItemBase({
  ...
  return (
    <ThemedView
      ...
      style={isDarkMode ? { borderWidth: 1, borderColor: theme.colors.neutral[700] } : theme.shadows.sm} // Adjusted dark border
    >
      ...
      <ThemedView className="p-3 flex-row items-center">
        ...
        <View className="ml-2 flex-1"> {/* Use standard View */}
          <View className="flex-row items-center"> {/* Use standard View */}
            {/* Use resolved user prop */}
      ...
      {/* Post content */}
      <View className="px-3 mb-2"> {/* Use standard View */}
      ...
      {/* Action buttons */}
      <ThemedView className="px-3 py-2 flex-row border-t" lightClassName="border-neutral-200" darkClassName="border-neutral-700"> {/* Adjusted dark border */}
        <TouchableOpacity
        ...
        >
          ...
          />
          <ThemedText className="ml-1" lightClassName="text-neutral-600" darkClassName="text-neutral-400"> {/* Adjusted dark text */}
