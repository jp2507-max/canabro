...
export default function AddTaskToPlantScreen() {
  ...
  const formatDate = useCallback((date: Date): string => {
    return date.toLocaleDateString(undefined, { // Use system locale instead of hardcoded 'de-DE'
      year: 'numeric',
      month: 'long',
      day: 'numeric',
    });
                  ...
                  {plants.map((plant) => (
                    ...
                    >
                      <ThemedText
                        ...
                        lightClassName={selectedPlant === plant.id ? 'text-white' : 'text-neutral-700'}
                        darkClassName={selectedPlant === plant.id ? 'text-white' : 'text-neutral-300'}
                      >
                        {plant.name}
                      </ThemedText>
                    </TouchableOpacity>
