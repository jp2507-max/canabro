 ...
 */
function prepareDataForWatermelonDB(apiStrain: RawStrainApiResponse): Partial<Strain> & { api_id: string } {
  ...
  const wdbData: Partial<Strain> & { api_id: string } = {
    ...
    floweringTime: floweringTime, // Single numeric field
    growDifficulty: apiStrain.growDifficulty ? sanitizeString(apiStrain.growDifficulty) : null,
    ...
    origin: JSON.stringify(originArray), // Storing as JSON string
    genetics: apiStrain.genetics ? sanitizeString(apiStrain.genetics) : null,
    floweringType: apiStrain.floweringType ? sanitizeString(apiStrain.floweringType) : null,
    heightIndoor: apiStrain.heightIndoor ? sanitizeString(apiStrain.heightIndoor) : null, // Text field
    heightOutdoor: apiStrain.heightOutdoor ? sanitizeString(apiStrain.heightOutdoor) : null, // Text field
    averageYield: apiStrain.average_yield ? sanitizeString(apiStrain.average_yield) : null, // Text field
    yieldIndoor: apiStrain.yieldIndoor ? sanitizeString(apiStrain.yieldIndoor) : null, // Text field
    yieldOutdoor: apiStrain.yieldOutdoor ? sanitizeString(apiStrain.yieldOutdoor) : null, // Text field
    harvestTimeOutdoor: apiStrain.harvestTimeOutdoor ? sanitizeString(apiStrain.harvestTimeOutdoor) : null,
