    ...
    try {
      ...
      await database.write(async () => {
        for (const reminder of careReminders) {
          ...
          const task = await database.get<PlantTask>('plant_tasks').create((newTask: any) => {
            ...
            newTask.userId = ''; // Will be set from plant relation
            newTask.priority = reminder.priorityLevel;
